...
public class Teachers extends JFrame implements ActionListener , MouseListener/*, ItemListener*/
{
	private JFrame f;
	...
	{    
		...
		con =  new JLabel();
		con.setText("Contact:");
		con.setFont(new Font("Viking Squad", Font.PLAIN, 20));
		con.setBounds(41, 590, 70, 14);
		bg.add(con);
		
		des = new JLabel();
		des.setText("Designation:");
		des.setFont(new Font("Viking Squad", Font.PLAIN, 20));
		des.setBounds(41, 610, 100, 14);
		bg.add(des);
		
		dep = new JLabel();
		dep.setText("Department:");
		dep.setFont(new Font("Viking Squad", Font.PLAIN, 20));
		...
		//table.setBounds(300,200,500,400);
